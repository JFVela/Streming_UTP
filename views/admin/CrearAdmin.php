...
<head>
    ...
    <title>Crear</title>
    <!--Styles-->
    <link rel="stylesheet" href="/assents/css/admin/login.css">
    <!--Sweet Alert-->
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-xl-10">
                        <div class="card rounded-3 text-black">
                            <div class="row g-0">
                                <div class="pequeña_Imagen col-lg-6 d-flex align-items-center gradient-custom-2"></div>
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <form action="" method="post" class="registrarUsuario" id="registroForm">
                                            ...
                                            <div class="text-center pt-1 mb-5 pb-1">
                                                <input class="btn_ingresar btn btn-block fa-lg gradient-custom-2 mb-3" type="submit" name="btnRegistrarAdmin" value="Registrarse Ahora!">
                                                <br>
