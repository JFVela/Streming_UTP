<footer class="py-1 my-auto">
    ...
    <ul class="social-icons list-unstyled d-flex justify-content-center">
        <li class="ms-3"><a class="text-muted" href="https://www.facebook.com"><i class="bi bi-facebook bi-3x"></i></a></li>
        <li class="ms-3"><a class="text-muted" href="https://www.whatsapp.com"><i class="bi bi-whatsapp bi-3x"></i></a></li>
        <li class="ms-3"><a class="text-muted" href="https://www.instagram.com"><i class="bi bi-instagram bi-3x"></i></a></li>
    </ul>
