...
if (!empty($_POST["btnRegistrarAdmin"])) {
    ...
    // Insertar usuario
    $query = $conexion->prepare("INSERT INTO usuarios (nombreUsuario, telefono, correo, contraseña,idRol) VALUES (?, ?, ?, ?, ?)");
    $query->bind_param('ssss', $ObtenerNombreUsuario, $ObtenerTelefono, $ObtenerCorreo, $contraseñaHash, $roles);
    ...
    if ($query->execute()) {
        ...
        if ($datos = $resultado->fetch_object()) {
            ...
            if (password_verify($contraseña, $datos->contraseña)) {
                ...
                echo "<script>window.location.href='/views/admin/CrearAdmin.php';</script>";
                die();
            } else {
